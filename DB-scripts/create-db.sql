...
CREATE TABLE staff(
  id INT PRIMARY KEY REFERENCES login_info(id), 
  first_name TEXT, 
  middle_name TEXT, 
  last_name TEXT, 
  email TEXT, 
...
CREATE TABLE programme(
  ...
  UCAS_code TEXT, 
  duration INT, 
  manager INT REFERENCES staff(id), 
  attendance TEXT, 
  school TEXT); 
...
CREATE TABLE timetable(
  module_code TEXT REFERENCES module(code), 
  meeting_type TEXT, 
  meeting_time DATE, 
  room TEXT);
...
CREATE TABLE prerequisites(
  module_code TEXT REFERENCES module(code), 
  prerequisite_code TEXT REFERENCES module(code));
...
CREATE TABLE project(
  ...
  supervisor_id INT REFERENCES staff(id), 
  assessor INT REFERENCES staff(id), 
  project_year DATE, 
  title TEXT);
...
CREATE TABLE coursework_result(
  coursework_id INT REFERENCES coursework(id), 
  student_id INT REFERENCES student(id), 
  result INT, 
  handed_in DATE);
...
CREATE TABLE questions(
  ...
  marks INT, 
  weight INT, 
  exam_code TEXT REFERENCES exam(code));
